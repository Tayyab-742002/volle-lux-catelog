...
import { LayoutDashboard, ShoppingBag, MapPin, Settings as SettingsIcon } from 'lucide-react'
...
export function AccountDashboardClient({
  ...
  const renderTabContent = useMemo(() => {
    switch (activeTab) {
      ...
      case 'addresses':
        return <AddressesTab userId={userId} initialAddresses={initialAddresses} />
      case 'settings':
